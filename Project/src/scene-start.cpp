...
void init(void) {
    ...
    //shaderProgram = InitShader("res/shaders/partF/vStart.glsl", "res/shaders/partF/fStart.glsl");
    shaderProgram = InitShader("res/shaders/partG/vEnd.glsl", "res/shaders/partG/fEnd.glsl"); //TASK G
